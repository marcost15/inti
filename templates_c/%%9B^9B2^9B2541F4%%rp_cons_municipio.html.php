<?php /* Smarty version 2.6.26, created on 2013-05-21 15:24:00
         compiled from rp_cons_municipio.html */ ?>
...
<p>
<div id = "indice">REPORTE DE EXPEDIENTES POR MUNICIPIO </br>Municipio: <?php echo $this->_tpl_vars['municipio_nombre']; ?>
</div>
</p>
...
<p>
<div id="boton">
<a href="xls_municipio.php" target="_xls"><img onmouseover='overlib("<strong>Generar .xls</strong>",WIDTH, 70)' src="./imagenes/excel.png" width="50" height="50" onmouseout='return nd();'/></a>
<a href='./grafico_municipio.php' class='claseiframe'><img onmouseover='overlib("<strong>Generar Grafico</strong>",WIDTH, 70)' src="./imagenes/grafico.png" width="50" height="50" onmouseout='return nd();'/></a></div>
<p>
</div><?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
