<?php /* Smarty version 2.6.26, created on 2013-05-21 16:11:58
         compiled from consmod_funcionarios.html */ ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "inicio.html", 'smarty_include_vars' => array('title' => 'Consultas de Funcionarios')));
...
<h4>Funcionarios Solicitados</h4>
<div id="resultados">
...
?>
	<tr>
		...
		<td><a href="modificar_funcionarios.php?id=<?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['id']; ?>
...
<?php else: ?>
	<?php if ($this->_tpl_vars['error1'] == 2): ?> 
		<h3>NO SE ENCONTRÓ FUNCIONARIO CON ESOS PARAMETROS, VERIFIQUE...</h3>
	<?php endif; ?>
<?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
