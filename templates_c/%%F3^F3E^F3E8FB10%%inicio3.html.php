<?php /* Smarty version 2.6.26, created on 2013-05-21 15:23:40
         compiled from inicio3.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'inicio3.html', 7, false),)), $this); ?>
<html>
	<head>
	...
	<body topmargin="0"  background="./imagenes/fondo1.jpg";>
		<div id = "fondoreporte">
		<div id="cintillo_reporte" align="center"><img src="./imagenes/cintillo.jpg" width="1050" height="60"/></div>
		<div id="titulo_reporte" align="center"> <br/> OFICINA REGIONAL DE TIERRAS DEL ESTADO TRUJILLO</div><!-- titulo -->	<br/>
			<div id="menu"><?php if ($_SESSION['usuario']): ?>
			...
			<div id="contenido_reporte"><!-- Contenido -->