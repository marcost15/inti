...
if (bd_verificar_privilegios('rp_frm_fecha.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
	ir('negacion_usuario.php');
}
$f1=new dbFormHandler('cierres',NULL,'onclick="highlight(event)"');
$f1->setLanguage('es');
$f1->addHTML(" <br />"."<div id='titulo'>EXPEDIENTES POR FECHA</div>"."<td colspan='3'><hr size='1' /></td>\n"." </tr>\n");
