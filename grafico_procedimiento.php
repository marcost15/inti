...
$c = sql2value("SELECT COUNT(id) FROM  tipos_procedimientos");
$programas = sql2array("SELECT id,nombre FROM  tipos_procedimientos");

$total=0;
foreach ($programas as $i=>$c)
{
$a = $programas[$i]['id'];
$programas[$i][cant] = sql2value("SELECT COUNT(*) FROM expedientes WHERE tipo_proc_id = '$a'");
...
$chart->setTitle("");
$chart->render("./graficos/grprocedimientoxexpediente.png");
$smarty->disp();