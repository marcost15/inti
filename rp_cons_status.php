...
if (bd_verificar_privilegios('rp_cons_status.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
	ir('negacion_usuario.php');
}
$id = $_REQUEST['id']; 
$plan_nombre_id = bd_obt_status($_REQUEST['id']);
$expediente = sql2array("SELECT id,solicitante_id,nombre_fundo,superficie,fecha,tipo_proc_id,plan_id,tipo,num_exp,num_solicitud_fenix,num_archivo,num_carpeta,
					fecha_remision,num_memo,status_id FROM expedientes WHERE status_id = '$id'");
