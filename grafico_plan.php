...
$c = sql2value("SELECT COUNT(id) FROM  programas_asociados");
$programas = sql2array("SELECT id,nombre FROM  programas_asociados");

$total=0;
foreach ($programas as $i=>$c)
{
$a = $programas[$i]['id'];
$programas[$i][cant] = sql2value("SELECT COUNT(*) FROM expedientes WHERE plan_id = '$a'");
...
$chart->setTitle("");
$chart->render("./graficos/grplanxexpediente.png");
$smarty->disp();