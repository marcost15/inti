...
$c = sql2value("SELECT COUNT(id) FROM  concejo_comunal");
$programas = sql2array("SELECT id,nombre FROM  concejo_comunal");

$total=0;
foreach ($programas as $i=>$c)
{
$a = $programas[$i]['id'];
$programas[$i][cant] = sql2value("SELECT COUNT(*) FROM expedientes,solicitantes WHERE solicitantes.id = solicitante_id AND  concejo_id = '$a'");
...
$chart->setTitle("");
$chart->render("./graficos/grconcejoxexpediente.png");
$smarty->disp();