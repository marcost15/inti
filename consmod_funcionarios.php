...
include './modelo/bd_buscar_funcionarios.php';
include './modelo/bd_obt_niveles.php';
$_SESSION['ini']=parse_ini_file('./configs/config.ini',true);
if (bd_verificar_privilegios('consmod_funcionarios.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->setLanguage('es');
$f1->addHTML(" <br />"."<div id='titulo'>BUSQUEDA DE FUNCIONARIOS</div>"."<td colspan='3'><hr size='1' /></td>\n"." </tr>\n");
...
function procesar($d)
{
	global $smarty;
	$texto=$d['texto'];
	$datos15 = bd_buscar_funcionarios(2,$texto);
	if (isset($datos15))
	{
		$error1 = '2';
	}
